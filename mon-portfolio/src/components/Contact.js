      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-12 max-w-5xl mx-auto">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-[#121212] border border-[#333333] rounded-xl p-6 sticky top-28">
              <h3 className="text-xl font-semibold mb-6 text-white">Mes coordonnées</h3>
              ...
              >
                <motion.li variants={itemVariants} className="flex items-center gap-4">
                  <div className="w-10 h-10 flex items-center justify-center rounded-full bg-amber-500/10 text-amber-500">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">Rabat, Maroc</p>
                  </div>
                </motion.li>
                ...
                <motion.li variants={itemVariants} className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">mosaablachhab06@gmail.com</p>
                  </div>
                </motion.li>
                ...
                <motion.li variants={itemVariants} className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">+212 645556569</p>
                  </div>
                </motion.li>
              </motion.ul>
              
              <div className="mt-8 border-t border-[#2a2a2a] pt-6">
                <p className="text-gray-400 mb-4 text-sm">Suivez-moi sur les réseaux</p>
                <div className="flex gap-4">
                  <motion.a 
                    ...
                    className="w-9 h-9 flex items-center justify-center rounded-full bg-[#1E1E1E] text-gray-400 hover:text-amber-500 transition-colors"
                  >
          ...
          >
            {formState.submitted ? (
              ...
              <form onSubmit={handleSubmit} className="bg-[#121212] border border-[#333333] rounded-xl p-8">
                ...
                >
                  <motion.div variants={itemVariants}>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#1A1A1A] border border-[#333333] rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-white"
                  ...
                  <motion.div variants={itemVariants}>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={6}
                      className="w-full px-4 py-3 bg-[#1A1A1A] border border-[#333333] rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-white resize-none"
                  ...
                  <motion.div variants={itemVariants} className="pt-2">
                    <motion.button
                      ...
                      className={`w-full md:w-auto px-8 py-3 rounded-lg bg-gradient-to-r from-amber-600 to-amber-500 text-white font-medium hover:shadow-lg hover:shadow-amber-600/20 transition-all ${formState.submitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                      type="submit"
                    >
